...
app.use(methodOverride("_method")); // We can change the parameter _method in the request and here, but it's conventional.
...
app.post("/blogs", function(req, res){
    req.body.blog.body = req.sanitize(req.body.blog.body) // as body of blog is where we stored
